...
if (lowArray[-1] <= lowerband[-1]):
    sendMail("【BTC/USDT】触5分BL下沿：" + str(closeArray[-1]), "【BTC/USDT】触5分BL下沿：" + str(closeArray[-1]))
if (highArray[-1] >= upperband[-1]):
    sendMail("【BTC/USDT】触5分BL上沿：" + str(closeArray[-1]), "【BTC/USDT】触5分BL上沿：" + str(closeArray[-1]))
