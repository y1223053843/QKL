...
def strategy(name,zhouqi):
    ...
    strMA = " MA15:" + "%.1f" % macdsignal[-1] + "—" + "%.1f" % macdhist[-3] + "/" + "%.1f" % macdhist[-2] + "/" + "%.1f" % macdhist[-1]
    # print(macdsignal)
    # print(macdhist)
    if (macdsignal[-1] > 0 and macdhist[-2] < macdhist[-1]):
        strMA = " MA15主买进:" + "%.1f" % macdsignal[-1] + "—" + "%.1f" % macdhist[-3] + "/" + "%.1f" % macdhist[-2] + "/" + "%.1f" % macdhist[-1]
        if (macdsignal[-2] < 0 and macdsignal[-1] > 0):
            strMA = " MA15负正转折（多）:" + "%.1f" % macdsignal[-1] + "—" + "%.1f" % macdhist[-3] + "/" + "%.1f" % macdhist[-2] + "/" + "%.1f" % macdhist[-1]
    if (macdsignal[-1] < 0 and macdhist[-2] > macdhist[-1]):
        strMA = " MA15主卖出:" + "%.1f" % macdsignal[-1] + "—" + "%.1f" % macdhist[-3] + "/" + "%.1f" % macdhist[-2] + "/" + "%.1f" % macdhist[-1]
        if (macdsignal[-2] > 0 and macdsignal[-1] < 0):
            strMA = " MA15正负转折（空）:" + "%.1f" % macdsignal[-1] + "—" + "%.1f" % macdhist[-3] + "/" + "%.1f" % macdhist[-2] + "/" + "%.1f" % macdhist[-1]
