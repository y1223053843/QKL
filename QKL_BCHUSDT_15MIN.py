...
if (lowArray[-1] <= lowerband[-1]):
    sendMail("BCH/USDT触15分BL下沿：" + str(closeArray[-1]), "BCH/USDT触15分BL下沿：" + str(closeArray[-1]))
if (highArray[-1] >= upperband[-1]):
    sendMail("BCH/USDT触15分BL上沿：" + str(closeArray[-1]), "BCH/USDT触15分BL上沿：" + str(closeArray[-1]))
