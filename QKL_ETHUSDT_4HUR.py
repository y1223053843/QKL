...
if (lowArray[-1] <= lowerband[-1]):
    sendMail("【ETH/USDT】触4小时BL下沿：" + str(closeArray[-1]), "【ETH/USDT】触4小时BL下沿：" + str(closeArray[-1]))
if (highArray[-1] >= upperband[-1]):
    sendMail("【ETH/USDT】触4小时BL上沿：" + str(closeArray[-1]), "【ETH/USDT】触4小时BL上沿：" + str(closeArray[-1]))
