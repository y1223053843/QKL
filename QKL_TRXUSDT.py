...
def strategy(name,zhouqi):
    ...
    ############################################ 01小时STOCHRSI#############################################
    fastk, fastd = ta.STOCHRSI(num.asarray(doubleCloseArray, dtype='double'), timeperiod=14, fastk_period=14,
                               fastd_period=3, fastd_matype=3)
    ...
    strMA = " MA15:" + "%.1f" % (macdsignal[-1] * 1000000) + "_" + "%.1f" % (macdhist[-3] * 1000000) + "/" + "%.1f" % (
                macdhist[-2] * 1000000) + "/" + "%.1f" % (macdhist[-1] * 1000000)
    if (macdsignal[-1] > 0 and macdhist[-2] < macdhist[-1]):
        strMA = " MA主多:" + "%.1f" % (macdsignal[-1] * 1000000) + "_" + "%.1f" % (
                    macdhist[-3] * 1000000) + "/" + "%.1f" % (macdhist[-2] * 1000000) + "/" + "%.1f" % (
                            macdhist[-1] * 1000000)
        if (macdsignal[-2] < 0 and macdsignal[-1] > 0):
            strMA = " MA负正多:" + "%.1f" % (macdsignal[-1] * 1000000) + "_" + "%.1f" % (
                        macdhist[-3] * 1000000) + "/" + "%.1f" % (macdhist[-2] * 1000000) + "/" + "%.1f" % (
                                macdhist[-1] * 1000000)
    if (macdsignal[-1] < 0 and macdhist[-2] > macdhist[-1]):
        strMA = " MA主空:" + "%.1f" % (macdsignal[-1] * 1000000) + "_" + "%.1f" % (
                    macdhist[-3] * 1000000) + "/" + "%.1f" % (macdhist[-2] * 1000000) + "/" + "%.1f" % (
                            macdhist[-1] * 1000000)
        if (macdsignal[-2] > 0 and macdsignal[-1] < 0):
            strMA = " MA正负空:" + "%.1f" % (macdsignal[-1] * 1000000) + "_" + "%.1f" % (
                        macdhist[-3] * 1000000) + "/" + "%.1f" % (macdhist[-2] * 1000000) + "/" + "%.1f" % (
                                macdhist[-1] * 1000000)
